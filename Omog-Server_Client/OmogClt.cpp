                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_OMOGCLT, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_OMOGCLT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_OMOGCLT));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_OMOGCLT);
    ...
    case WM_LBUTTONDOWN:
        ...
        if (flag == 1) {
            if (x < 22 && y < 22 && isCheck[x][y] == 0) {
                ...
                send(sv, buff, strlen(buff) + 1, NULL);
                flag = 0;
            }
        }
        InvalidateRgn(hWnd, NULL, true);
